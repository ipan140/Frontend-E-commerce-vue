...
<template>
  <header
    class="sticky top-0 z-[999] w-full bg-white border-b border-gray-200 dark:border-gray-800 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div class="flex items-center gap-2 md:gap-4">
          ...
          <div class="hidden md:flex relative group mr-2">
            ...
            <input type="text" placeholder="Search..."
              class="w-40 lg:w-64 rounded-xl border border-gray-200 bg-gray-50 py-2 pl-9 pr-4 text-xs font-bold transition-all focus:border-brand-500/50 focus:bg-white focus:ring-4 focus:ring-brand-500/5 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-200 focus:outline-none" />
          </div>
          ...
          <router-link to="/cart"
            class="relative flex h-9 w-9 md:h-10 md:w-10 items-center justify-center rounded-xl border border-gray-100 bg-white shadow-theme-xs text-gray-500 transition-all hover:bg-gray-50 hover:text-brand-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 dark:hover:text-white active:scale-95">
          ...
          <router-link to="/signin"
            class="flex items-center gap-2 md:gap-3 pl-1 sm:pl-2 pr-1 py-1 rounded-xl transition-all hover:bg-gray-50 dark:hover:bg-white/[0.03] active:scale-95 group border border-transparent hover:border-gray-100 dark:hover:border-gray-800">
          ...
          <button @click="toggleMobileMenu"
            class="lg:hidden flex h-9 w-9 md:h-10 md:w-10 items-center justify-center rounded-xl border border-gray-100 bg-white shadow-theme-xs text-gray-500 hover:bg-gray-50 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 active:scale-95 transition-all">
    ...
    <transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0 -translate-y-4"
      ...
      <div v-if="isMobileMenuOpen"
        class="lg:hidden absolute top-16 left-0 w-full bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-2xl z-50 overflow-hidden">
        <div class="px-4 py-6 sm:px-6 space-y-6 max-h-[calc(100vh-4rem)] overflow-y-auto">
