    ...
    <div
        ...
        <main class="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 py-6 md:py-8 space-y-8">
            ...
            <div class="flex flex-col lg:flex-row gap-6 md:gap-8">
                ...
                <aside class="w-full lg:w-[260px] shrink-0 space-y-4 lg:space-y-6">

                    <div
                        class="bg-white dark:bg-white/[0.02] border border-gray-100 dark:border-gray-800 rounded-2xl p-5 md:p-6 shadow-theme-sm transition-all">
                        <button @click="isCategoryOpen = !isCategoryOpen"
                            class="w-full flex justify-between items-center cursor-pointer group focus:outline-none">
                            <h3
                                class="text-sm font-black uppercase tracking-widest flex items-center gap-2 text-gray-900 dark:text-white group-hover:text-brand-500 transition-colors">
                                <Menu :size="18" class="text-brand-500" /> Semua Kategori
                            </h3>
                            <ChevronDown :size="18" class="text-gray-500 transition-transform duration-300"
                                :class="{ 'rotate-180': !isCategoryOpen }" />
                        </button>

                        <div v-show="isCategoryOpen" class="mt-4 space-y-1">
                    ...
                    <div
                        ...
                        <div v-show="isFilterOpen">
                            <div class="border-b border-gray-100 dark:border-gray-800 my-4"></div>
                            ...
                            <div class="mb-6">
                                <h4 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Tipe Penjual
                                </h4>
                                <div class="space-y-2.5">
                            ...
                            <div class="mb-6">
                                <h4 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Batas Harga
                                </h4>
                            ...
                            <div class="mb-6">
                                <h4 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Penilaian
                                </h4>
                                <div class="space-y-1">
